        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
               ...
               <button id="getuser" class="btn btn-primary btn-sm btn-flat" type="button" onclick="alert('Hello World')"><i class="fa fa-plus"></i> Get User</button>
            </div>
            <div class="box-body">
