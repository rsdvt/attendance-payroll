    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Tambah Lembur</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                  	<label for="hours" class="col-sm-3 control-label">Jumlah Jam</label>
                ...
                <div class="form-group">
                  	<label for="mins" class="col-sm-3 control-label">Jumlah Menit</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="hours_edit" class="col-sm-3 control-label">Jumlah Jam</label>
                ...
                <div class="form-group">
                    <label for="mins_edit" class="col-sm-3 control-label">Jumlah Menit</label>
