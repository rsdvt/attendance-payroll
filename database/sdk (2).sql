...
--
-- Host: localhost
-- Generation Time: Oct 15, 2019 at 08:06 AM
...
(1, '1', 0, '2019-10-15', '02:15:40', 0, '02:15:57', 0);
...
--
-- Table structure for table `tb_penampilan`
--
...
--
DELIMITER $$
CREATE TRIGGER `add_employee` BEFORE INSERT ON `tb_user` FOR EACH ROW INSERT INTO employees SET employee_id=new.pin, pin=new.pin, firstname=new.nama, created_on=CURRENT_DATE
$$
DELIMITER ;
...
--
-- Indexes for table `tb_penampilan`
--
...
--
-- AUTO_INCREMENT for table `tb_penampilan`
--
ALTER TABLE `tb_penampilan`
